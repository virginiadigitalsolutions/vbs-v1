...
export const learningHubFallbackSections = [
    {
...
export async function getLearningHubListingData({ categoryId = null, searchQuery = '' } = {}) {
    ...
    const selectedCategory = categoryId && Number.isFinite(categoryId)
    ...
    return {
        ...
        visiblePosts: posts.length > 1 ? posts.slice(1) : posts,
        sectionsToRender: page?.sections?.length ? page.sections : learningHubFallbackSections,
        selectedCategory,
