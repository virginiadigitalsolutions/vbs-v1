    ...
    useEffect(() => {
        async function load() {
            try {
                ...
                setPageData(privacyPage)

                const secRes = await fetch(`/api/admin/sections?pageId=${privacyPage.id}`)
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 font-bold text-sm">Loading Privacy page...</p>
                </div>
            </div>
        )
    }
    ...
    if (!pageData) {
        return (
            <div className="max-w-3xl mx-auto px-6 py-20 text-center animate-fade-up">
                ...
                <p className="text-gray-500 font-medium mb-6">The Privacy page hasn&apos;t been seeded yet.</p>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div>
                            ...
                            <p className="text-gray-500 font-medium text-sm max-w-lg">
                                Manage all sections of the Privacy Policy. Edit content, reorder sections, and toggle visibility.
                            </p>
