...
const layoutLabels = {
    ...
    career_intro: 'Introduction',
    career_why_clarity: 'Why Clarity & Skills to Roles',
    career_progression: 'Career Progression',
    career_growth: 'Growth & Earning Potential',
    career_ai_mistakes: 'AI Influence & Mistakes',
    career_aligning: 'Aligning Direction',
}

export default function AdminCareerGuidesPage() {
    ...
    useEffect(() => {
        async function load() {
            try {
                ...
                const careerPage = pages.find(p => p.slug === 'career-guides')
                ...
                setPageData(careerPage)

                const secRes = await fetch(`/api/admin/sections?pageId=${careerPage.id}`)
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 font-bold text-sm">Loading Career Guides page...</p>
                </div>
            </div>
        )
    }
    ...
    if (!pageData) {
        return (
            <div className="max-w-3xl mx-auto px-6 py-20 text-center animate-fade-up">
                ...
                <p className="text-gray-500 font-medium mb-6">The Career Guides page hasn&apos;t been seeded yet.</p>
                <p className="text-sm text-gray-400 font-mono bg-gray-50 inline-block px-4 py-2 rounded-xl border">
                    Run: node scripts/seed-pillar-pages.js
                </p>
            </div>
        )
    }
        ...
        <div className="w-full">
            <div className="max-w-4xl mx-auto px-6 py-10 animate-fade-up">
                ...
                <div className="mb-10 bg-white border border-gray-100 rounded-3xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-40 h-40 bg-emerald-50/60 rounded-bl-full -z-10" />
                    <div className="absolute bottom-0 left-0 w-24 h-24 bg-teal-50/40 rounded-tr-full -z-10" />

                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span className="text-2xl">🧭</span>
                                <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Career Guides</h1>
                            </div>
                            <p className="text-gray-500 font-medium text-sm max-w-lg">
                                Manage all sections of the Career Guides page. Edit content, reorder sections, and toggle visibility.
                            </p>
                                    ...
                                    <div className="flex items-center gap-4 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-gray-400 font-medium truncate max-w-md">
                                                {displayHeading.length > 60 ? displayHeading.slice(0, 60) + '...' : displayHeading}
                                            </p>
                                        </div>
                                    </div>
