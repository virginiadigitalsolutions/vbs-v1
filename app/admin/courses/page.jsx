...
const layoutLabels = {
    ...
    courses_intro: 'Introduction',
    courses_structure: 'Why Structure',
    courses_progression: 'Learning Progression',
    courses_free_paid: 'Free vs Paid',
    courses_eval_mistakes: 'Evaluation & Mistakes',
    courses_connecting: 'Connecting Learning',
}
    ...
    useEffect(() => {
        async function load() {
            try {
                ...
                const coursesPage = pages.find(p => p.slug === 'courses-certifications')
                ...
                setPageData(coursesPage)

                const secRes = await fetch(`/api/admin/sections?pageId=${coursesPage.id}`)
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 font-bold text-sm">Loading Courses & Certifications page...</p>
                </div>
            </div>
        )
    }
    ...
    if (!pageData) {
        return (
            <div className="max-w-3xl mx-auto px-6 py-20 text-center animate-fade-up">
                ...
                <p className="text-gray-500 font-medium mb-6">The Courses & Certifications page hasn&apos;t been seeded yet.</p>
        ...
        <div className="w-full">
            <div className="max-w-4xl mx-auto px-6 py-10 animate-fade-up">
                ...
                <div className="mb-10 bg-white border border-gray-100 rounded-3xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-40 h-40 bg-cyan-50/60 rounded-bl-full -z-10" />
                    <div className="absolute bottom-0 left-0 w-24 h-24 bg-amber-50/40 rounded-tr-full -z-10" />

                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span className="text-2xl">📚</span>
                                <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Courses & Certifications</h1>
                            </div>
                            <p className="text-gray-500 font-medium text-sm max-w-lg">
                                Manage all sections of the Courses & Certifications page. Edit content, reorder sections, and toggle visibility.
                            </p>
