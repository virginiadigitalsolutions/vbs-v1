...
const layoutLabels = {
    ...
    about_intro: 'Introduction (Mission & Vision)',
    about_audience: 'Who We Serve',
    about_approach: 'Our Approach',
    about_different: 'What Makes This Different',
    about_cta: 'Building Careers CTA',
}
    ...
    useEffect(() => {
        async function load() {
            try {
                ...
                setPageData(termsPage)

                const secRes = await fetch(`/api/admin/sections?pageId=${termsPage.id}`)
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 font-bold text-sm">Loading Terms page...</p>
                </div>
            </div>
        )
    }
    ...
    if (!pageData) {
        return (
            <div className="max-w-3xl mx-auto px-6 py-20 text-center animate-fade-up">
                ...
                <p className="text-gray-500 font-medium mb-6">The Terms page hasn&apos;t been seeded yet.</p>
        ...
        <div className="w-full">
            <div className="max-w-4xl mx-auto px-6 py-10 animate-fade-up">
                ...
                <div className="mb-10 bg-white border border-gray-100 rounded-3xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-40 h-40 bg-violet-50/60 rounded-bl-full -z-10" />
                    <div className="absolute bottom-0 left-0 w-24 h-24 bg-purple-50/40 rounded-tr-full -z-10" />

                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span className="text-2xl">⚖️</span>
                                <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Terms & Conditions</h1>
                            </div>
                            <p className="text-gray-500 font-medium text-sm max-w-lg">
                                Manage all sections of the Terms & Conditions page. Edit content, reorder sections, and toggle visibility.
                            </p>
