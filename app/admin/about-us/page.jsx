    ...
    useEffect(() => {
        async function load() {
            try {
                ...
                const secRes = await fetch(`/api/admin/sections?pageId=${aboutPage.id}`)
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 font-bold text-sm">Loading About page...</p>
                </div>
            </div>
        )
    }
    ...
    if (!pageData) {
        return (
            <div className="max-w-3xl mx-auto px-6 py-20 text-center animate-fade-up">
                ...
                <p className="text-gray-500 font-medium mb-6">The About page hasn&apos;t been seeded yet.</p>
                <p className="text-sm text-gray-400 font-mono bg-gray-50 inline-block px-4 py-2 rounded-xl border">
                    Run: node scripts/seed-about.js
                </p>
            </div>
        )
    }
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">About Us</h1>
                            </div>
                            <p className="text-gray-500 font-medium text-sm max-w-lg">
                                Manage all sections of the About page. Edit content, reorder sections, and toggle visibility.
                            </p>
